...
describe('total likes', () => {
  ...
  test('when list has many blogs, equals the sum of the blogs likes', () => {
...
describe('most blogs', () => {
  ...
  test('when list has many blogs, equals the author who has most blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list has many blogs, equals the author who has most liked', () => {
